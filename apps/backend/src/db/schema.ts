...
export const users = pgTable(
  ...
  (t) => [index('idx_user_is_active').on(t.isActive)],
);
...
export const systemModules = pgTable(
  ...
  (t) => [index('idx_system_module_is_active').on(t.isActive)],
);

export const usersSystemAccess = pgTable(
  'users_system_access',
  {
    userId: text('userId')
      .notNull()
      .references(() => users.id, { onDelete: 'cascade' }),
    systemModuleId: text('systemModuleId')
      .notNull()
...
export const groupSystemAccess = pgTable(
  'group_system_access',
  {
    groupId: text('groupId')
      .notNull()
...
export const auditLogs = pgTable(
  ...
  (t) => [index('idx_audit_log_user_timestamp').on(t.userId, t.timestamp)],
);
...
export const avaProgressReport = pgTable(
  'ava_progress_report',
  {
    id: text('id')
      .primaryKey()
  ...
  (t) => [
    ...
    index('idx_ava_progress_institution_period').on(
      t.sourceInstitution,
      t.periodo,
    ),
    index('idx_ava_progress_profile_filters').on(
      t.sourceInstitution,
      t.periodo,
      t.cursoPerfil,
      t.periodoPerfil,
    ...
    index('idx_ava_progress_aluno_trgm').using(
      'gin',
      t.aluno.op('gin_trgm_ops'),
    ),
    index('idx_ava_progress_curso_trgm').using(
      'gin',
      t.curso.op('gin_trgm_ops'),
    ),
    index('idx_ava_progress_usuario_trgm').using(
      'gin',
      t.usuario.op('gin_trgm_ops'),
    ),
    index('idx_ava_progress_matricula_trgm').using(
      'gin',
      t.matricula.op('gin_trgm_ops'),
    ),
  ],
);

export const avaGradesReport = pgTable(
  'ava_grades_report',
  {
    id: text('id')
      .primaryKey()
  ...
  (t) => [
    ...
    index('idx_ava_grades_institution_period').on(
      t.sourceInstitution,
      t.periodo,
    ),
    index('idx_ava_grades_profile_filters').on(
      t.sourceInstitution,
      t.periodo,
      t.cursoPerfil,
      t.periodoPerfil,
    ...
    index('idx_ava_grades_student_trgm').using(
      'gin',
      t.studentName.op('gin_trgm_ops'),
    ),
    index('idx_ava_grades_course_trgm').using(
      'gin',
      t.courseFullname.op('gin_trgm_ops'),
    ),
    index('idx_ava_grades_username_trgm').using(
      'gin',
      t.userUsername.op('gin_trgm_ops'),
    ),
    index('idx_ava_grades_identification_trgm').using(
      'gin',
      t.userIdentification.op('gin_trgm_ops'),
    ),
  ],
);

export const avaConsolidatedReport = pgTable(
  ...
  (t) => [
    ...
    index('idx_ava_consolidated_inst_period').on(
      t.sourceInstitution,
      t.periodo,
    ),
    index('idx_ava_consolidated_filters').on(
      t.sourceInstitution,
      t.periodo,
      t.cursoPerfil,
      t.periodoPerfil,
    ...
    index('idx_ava_consolidated_status').on(
      t.sourceInstitution,
      t.enrolmentStatus,
    ),
    index('idx_ava_consolidated_aluno_trgm').using(
      'gin',
      t.aluno.op('gin_trgm_ops'),
    ),
    index('idx_ava_consolidated_curso_trgm').using(
      'gin',
      t.curso.op('gin_trgm_ops'),
    ),
    index('idx_ava_consolidated_matricula_trgm').using(
      'gin',
      t.matricula.op('gin_trgm_ops'),
    ),
  ],
...
export const agendamentosMatricula = pgTable(
  'agendamentos_matricula',
  {
    id: text('id')
      .primaryKey()
      .$defaultFn(() => crypto.randomUUID()),
    opcaoId: text('opcaoId')
      .notNull()
      .references(() => opcaos.id, { onDelete: 'cascade' }),
...
export const syncedTurmas = pgTable(
  'synced_turma',
  {
...
export const syncedUsuarios = pgTable(
  'synced_usuario',
  {
    unidadeEns: text('unidadeEns').notNull(),
    username: text('username').notNull(),
  },
  (t) => [primaryKey({ columns: [t.unidadeEns, t.username] })],
);

export const syncedMatriculas = pgTable(
  'synced_matricula',
  {
    unidadeEns: text('unidadeEns').notNull(),
...
export const academicTurma = pgTable(
  'academic_turma',
  {
  ...
  (t) => [
    ...
    index('idx_ac_turma_disc_trgm').using(
      'gin',
      t.disciplina.op('gin_trgm_ops'),
    ),
    index('idx_ac_turma_nome_disc_trgm').using(
      'gin',
      t.nomeDisciplina.op('gin_trgm_ops'),
    ),
  ],
);

export const academicDiscente = pgTable(
  'academic_discente',
  {
  ...
  (t) => [
    ...
    index('idx_ac_discente_sobrenome_trgm').using(
      'gin',
      t.sobrenome.op('gin_trgm_ops'),
    ),
    index('idx_ac_discente_cpf_trgm').using('gin', t.cpf.op('gin_trgm_ops')),
    index('idx_ac_discente_mat_trgm').using(
      'gin',
      t.matricula.op('gin_trgm_ops'),
    ),
    index('idx_ac_discente_usu_trgm').using(
      'gin',
      t.usuario.op('gin_trgm_ops'),
    ),
  ],
...
export const academicDocente = pgTable(
  'academic_docente',
  {
    id: text('id').primaryKey(),
    nome: text('nome'),
  ...
  (t) => [
    ...
    index('idx_ac_docente_sobrenome_trgm').using(
      'gin',
      t.sobrenome.op('gin_trgm_ops'),
    ),
...
export const academicMatricula = pgTable(
  'academic_matricula',
  {
    id: text('id')
      .primaryKey()
